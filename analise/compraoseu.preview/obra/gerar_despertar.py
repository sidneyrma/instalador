...
.capa .capa-img{max-width:280px; border-radius:10px; box-shadow:0 25px 60px rgba(0,0,0,.5); border:1px solid rgba(201,162,75,.4); margin-bottom:2rem}
...
<section class="capa">
  ...
  <img class="capa-img" src="{CAPA}" alt="{esc(TITULO)} — capa mística">
  <h1>{esc(TITULO)}</h1>
