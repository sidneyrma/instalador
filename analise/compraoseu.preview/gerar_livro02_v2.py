...
SRC = HERE.parent / "livro02_reescrito" / "obra_livro02_v2.md"
OUT = HERE.parent.parent / "paginas" / "livro02_preview.html"
...
CAPA = "https://i.ibb.co/yBNkHB7q/livro02.jpg"
...
document.addEventListener('copy', function(e){
  ...
  if (e.clipboardData){
    e.clipboardData.setData('text/plain',
      '© Coleção do Despertar — A Sabedoria dos Mestres. Todos os direitos reservados. Leitura online em compraoseu.com');
  }
});
...
<meta property="og:description" content="Uma obra original sobre as leis da vibração, a linguagem do universo e o retorno do mestre interior. Leitura online gratuita e protegida.">
...
<meta name="twitter:description" content="Uma obra original sobre as leis da vibração, a linguagem do universo e o retorno do mestre interior. Leitura online gratuita e protegida.">
...
<section id="fim">
  <h2>O Mestre Permanece com Você</h2>
  <p>"A jornada termina aqui, mas o mestre permanece com você, para sempre, dentro. Vivo, presente, silencioso, eterno."</p>
  <p>Que a sabedoria dos mestres desperte em você o conhecimento que liberta a alma.</p>
