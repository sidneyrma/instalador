# -*- coding: utf-8 -*-
"""
Gera a página de leitura do Livro 03 reescrito — "A Mente Renovada"
a partir da obra original (obra_livro03_v2.md).
...
SRC = HERE.parent / "livro03_reescrito" / "obra_livro03_v2.md"
OUT = HERE.parent.parent / "paginas" / "livro03_preview.html"
...
def build():
    ...
    for linha in texto.split('\n'):
        ...
        if linha.startswith('## '):
            ...
            if titulo.upper() in ('PRÓLOGO', 'PROLOGO', 'EPÍLOGO', 'EPILOGO', 'ORAÇÃO FINAL', 'ORACAO FINAL'):
...
document.addEventListener('copy', function(e){
  ...
  if (e.clipboardData){
    e.clipboardData.setData('text/plain',
      '© Coleção do Despertar — A Mente Renovada. Todos os direitos reservados. Leitura online em compraoseu.com');
  }
});
...
<meta property="og:description" content="Uma obra original da Coleção do Despertar sobre a renovação da mente, o governo do pensamento, a oração e a gratidão. Leitura online gratuita e protegida.">
...
<meta name="twitter:description" content="Uma obra original da Coleção do Despertar sobre a renovação da mente, o governo do pensamento, a oração e a gratidão. Leitura online gratuita e protegida.">
...
<section class="capa">
  <img class="capa-livro" src="{CAPA}" alt="Capa do livro A Mente Renovada">
...
<section id="fim">
  <h2>A Mente que Permanece</h2>
  <p>"E não vos conformeis com este mundo, mas transformai-vos pela renovação da vossa mente, para que experimenteis qual seja a boa, agradável e perfeita vontade de Deus." (Romanos 12:2)</p>
  <p>Que a mente renovada, despertada nestas páginas, cresça em você até que a sua vida se torne uma expressão viva da paz de Cristo, do amor de Deus e da esperança que não se apaga.</p>
