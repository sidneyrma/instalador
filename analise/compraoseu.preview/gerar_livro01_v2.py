...
SRC = HERE.parent / "livro01_reescrito" / "obra_livro01_v2.md"
OUT = HERE.parent.parent / "paginas" / "livro01_preview.html"

TITULO = "O Verbo que Transforma"
SUBTITULO = "O Poder Criador da Palavra e da Fé"
URL = "https://www.compraoseu.com/livro01"
CAPA = "https://sidneyrma.github.io/instalador/capas/livro01.png?v=2"
...
document.addEventListener('copy', function(e){
  ...
  if (e.clipboardData){
    e.clipboardData.setData('text/plain',
      '© Coleção do Despertar — O Verbo que Transforma. Todos os direitos reservados. Leitura online em compraoseu.com');
  }
});
...
<meta property="og:description" content="Uma obra original sobre o poder criador da palavra e da fé, para a saúde, a abundância e a superação. Leitura online gratuita e protegida.">
...
<meta name="twitter:description" content="Uma obra original sobre o poder criador da palavra e da fé, para a saúde, a abundância e a superação. Leitura online gratuita e protegida.">
...
<section class="capa">
  <img class="capa-livro" src="{CAPA}" alt="Capa do livro O Verbo que Transforma">
...
<section id="fim">
  <h2>A Palavra que Permanece</h2>
  <p>"A palavra que permanece é a que se torna vida. E a sua vida, agora, é a palavra."</p>
  <p>Que a palavra que transforma, despertada nestas páginas, cresça em você até que a sua vida se torne uma declaração viva de fé, amor e esperança.</p>
